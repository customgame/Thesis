...
class SIM900
{
  ...
  public:
    SIM900(long baudRate)
    {
      Serial.println("GSM constructor");
    ...
    bool isReportConfirmed()
    {
      ...
      if(GSMDataAvailable)
      {
        ...
        if(GSMData=="OK")
        {
          Serial.println("msg received: OK");
          GSMData="";
          GSMDataAvailable=false;
          a=true;
        }
